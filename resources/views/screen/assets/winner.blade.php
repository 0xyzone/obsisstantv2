<x-screen>
    ...
    <div class="w-full h-full flex justify-center items-center">
        <div class="flex flex-col items-center w-full">
            <img src="{{ $activeMatch->winner->logo ? asset('storage/' . $activeMatch->winner->logo) : '' }}" alt="" class="w-64 aspect-square object-scale-down shadow-xl bg-white rounded-lg p-4">
