<x-roster :tournament=$tournament :activeMatch=$activeMatch>
    ...
    <div class="grid grid-cols-5 items-center max-w-[1720px] gap-2 text-center w-full">
        ...
        <div class="">
            <img src="{{ $stat->player->portrait ? asset('storage/' . $stat->player->portrait) : ($stat->player->gender == "male" ? asset('img/placeholder/1.png') : asset('img/placeholder/2.png'))  }}" alt="" class="w-full">
